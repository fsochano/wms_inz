...
import com.sochanski.order.Order;
import com.sochanski.order.OrderLine;
...
public class DatabaseLoader implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
        ...
        orderRepository.save(new Order("order-1", lines));
        ...
        orderRepository.save(new Order("order-2", lines));
        ...
        orderRepository.save(new Order("order-3", lines));
